# Analysis of internet sale revenue
you are a business intelligence specialist
## the following star/snowflak schema ist given
```yaml
tables:
...
## Task
- provide between 5 complex business questions about internet sale revenue analysis
- for each question 
  - explain intend
  - generate corresponding SQL code that captures the intend based on the given database schema


# Output
the output should be put into a markdown file with name internet-revenue-sales-analysis.md in directory databases/adw-olap
