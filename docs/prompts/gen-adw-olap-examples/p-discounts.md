...
## Task
- provide between 5 complex business questions about discounts
- for each question 
  - explain intend
...
# Output
the output should be put into a markdown file with name q-discounts.md in directory databases/adw-olap
