...
## Task
- provide between 5 complex business questions about customer cohort analysis
- for each question 
  - explain intend
...
# Output
the output should be put into a markdown file with name q-customer-cohort.md in directory databases/adw-olap
