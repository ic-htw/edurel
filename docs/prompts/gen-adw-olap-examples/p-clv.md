# Analysis of customer life cycle value
...
## Task
- provide between 5 complex business questions about customer life cycle value
- for each question 
  - explain intend
...
# Output
the output should be put into a markdown file with name q-clv.md in directory databases/adw-olap
