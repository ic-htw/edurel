...
explain the following multidimensional schema
...
- tablename: DimScenario
  ...
  primary_key:
  - ScenarioKey
- tablename: FactAdditionalInternationalProductDescription
  columns:
  - columnname: ProductKey
    type: INTEGER
...
- tablename: NewFactCurrencyRate
  ...
  - columnname: DateKey
    type: INTEGER
- tablename: ProspectiveBuyer
  columns:
  - columnname: ProspectiveBuyerKey
    type: INTEGER
  - columnname: ProspectAlternateKey
    type: VARCHAR
  - columnname: FirstName
    type: VARCHAR
  - columnname: MiddleName
